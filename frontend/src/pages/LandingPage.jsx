import { Building2, Users, DollarSign, Calendar, BarChart3, FileText, CheckCircle2, ArrowRight, Shield, Zap, Lock, TrendingUp, Clock, Database, Smartphone } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-4">
              <button className="px-8 py-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all font-semibold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 flex items-center gap-2">
                Start Free Trial
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <button className="px-8 py-4 bg-white text-blue-600 rounded-xl hover:bg-blue-50 transition-all font-bold text-lg shadow-xl hover:shadow-2xl transform hover:-translate-y-0.5 flex items-center gap-2">
              Start Free Trial
              <ArrowRight className="w-5 h-5" />
            </button>
            <button className="px-8 py-4 bg-blue-500 text-white rounded-xl hover:bg-blue-400 transition-all font-bold text-lg border-2 border-blue-400">
              Schedule Demo
            </button>
          </div>
